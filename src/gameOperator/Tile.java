...
public class Tile 
{
	...
	//make this into constructor once game is done.
	private int value;
	...
	private void drawImage()
	{
		...
		int drawX = WIDTH/2 - DrawUtils.wordsWidth("" + value, font,g)/2;
		int drawY = HEIGHT/2 + DrawUtils.wordsHeight("" + value, font,g)/2;
